...
% non-missing pixels surrounding it. It first uses diagonal distance 1 to
% find non-missing pixels. If they is none, it checks surrounding pixels at
% vertical and horizontal distance 1 and so on. Finally, it stops at distance
...
function img_filled = fillMissingPixels4DiagonalFirst(img, msk, max_dist)
